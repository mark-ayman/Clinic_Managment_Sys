...
u8 patient_voidEdit	(List * Clinic_List,u8 local_u8IDpatient);		//Done
void patient_voidView	(List * Clinic_List,u8 local_u8IDpatient);	//Done
...
u8 patient_u8SearchID	(List * Clinic_List,u16 local_u8PatientID);	//Done
void patient_voidEnterID(patient * patient_pointer);				//Done
void patient_voidprintData (patient * patient_pointer);				//Done
void patient_voidEditPatientName(patient * patient_pointer);		//Done
void patient_voidEditPatientage(patient * patient_pointer);         //Done
void patient_voidEditPatientGender(patient * patient_pointer);      //Done
void patient_voidEditPatientID(patient * patient_pointer);          //Done
